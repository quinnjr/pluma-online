...
import { PipelineUncheckedUpdateManyWithoutUserInput } from '../pipeline/pipeline-unchecked-update-many-without-user.input';
...
@InputType()
export class UserUncheckedUpdateWithoutRegistrationInput {
    ...
    @Field(() => PipelineUncheckedUpdateManyWithoutUserInput, {nullable:true})
    pipelines?: PipelineUncheckedUpdateManyWithoutUserInput;
