...
import { UserCreateNestedOneWithoutPipelinesInput } from '../user/user-create-nested-one-without-pipelines.input';
...
export class PipelineCreateInput {
    ...
    @Field(() => UserCreateNestedOneWithoutPipelinesInput, {nullable:true})
