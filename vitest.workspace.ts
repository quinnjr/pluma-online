...
export default defineWorkspace([
	{
		// Node project: server/unit tests only — no DOM matchers loaded.
		plugins: [svelte()],
	...
	{
		// jsdom project: component render tests — @testing-library/jest-dom matchers
		// are loaded via setupFiles; svelteTesting() ensures browser resolve conditions.
